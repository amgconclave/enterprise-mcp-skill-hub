...
class DashboardSmokeService:
    ...
    def _expected_views(self) -> list[JsonDict]:
        return [
            ...
            {"id": "repository_automation", "label": "Repository Automation", "purpose": "Dry-run repo automation with sandboxed task plans."},
    ...
    def _endpoint_references(self) -> list[JsonDict]:
        return [
            ...
            self._endpoint_ref("repository_automation_plan", "GET", "/repository/automation-plan", "Dry-run repository automation task plan."),
            self._endpoint_ref("repository_automation_pack", "POST", "/repository/automation-pack", "Writes Repository Automation dry-run artifacts."),
    ...
    def _local_run_commands(self) -> list[str]:
        return [
            ...
            'rg "repository/automation-plan|repository/automation-pack|Repository Automation|repository_automation|repo automation" app dashboard docs README.md tests scripts sample_data',
            'rg "runtime/demo-readiness|runtime/demo-pack|Runtime Demo|runtime_packs|runtime_check|start_demo" app dashboard docs README.md tests scripts sample_data',
            'rg "api/contract-audit|api/reviewer-collection|API Contract|api_contracts|Reviewer Collection|OpenAPI" app dashboard docs README.md tests scripts sample_data',
    ...
    def _artifact_catalog(self) -> list[JsonDict]:
        return [
            ...
            self._catalog_row(
                ...
                Path("data") / "repository_automation",
                "POST /repository/automation-pack",
                "Invoke-RestMethod http://localhost:8000/repository/automation-pack -Method POST -Headers $headers",
                ["repo_automation_pack_latest.json", "repo_automation_pack_latest.md"],
                "Sandboxed dry-run repository task plan with transparent runbook steps, blocked mutation metadata, and verification commands.",
            ),
            self._catalog_row(
                "runtime_packs",
                "Runtime Demo Server Pack",
