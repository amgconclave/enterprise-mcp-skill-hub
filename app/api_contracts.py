...
class ApiContractService:
    ...
    IMPORTANT_ENDPOINTS = [
        ...
        ("GET", "/marketplace/promotion-gate/{skill_id}"),
        ("POST", "/marketplace/approvals/submit"),
        ("POST", "/marketplace/approvals/{approval_id}/decision"),
        ("POST", "/marketplace/approvals/{approval_id}/stage"),
        ("POST", "/marketplace/approval-pack"),
        ...
        ("GET", "/sandbox/exceptions"),
        ("POST", "/sandbox/exceptions"),
        ("POST", "/sandbox/exceptions/{exception_id}/decision"),
    ...
    def _expected_status_codes(self) -> list[JsonDict]:
        return [
            ...
            {
                "method": "GET",
                "path": "/marketplace/promotion-gate/{skill_id}",
                "with_api_key": True,
                "expected_status": 200,
            },
            ...
            {"method": "GET", "path": "/policy/replay-drift", "with_api_key": True, "expected_status": 200},
            {
                "method": "POST",
                "path": "/policy/replay-pack",
                "with_api_key": True,
                "expected_status": 200,
            },
            ...
            {"method": "GET", "path": "/marketplace/approvals", "with_api_key": True, "expected_status": 200},
            {
                "method": "POST",
                "path": "/marketplace/approval-pack",
                "with_api_key": True,
                "expected_status": 200,
            },
            {
    ...
    def _sample_commands(self) -> JsonDict:
        return {
            ...
            "curl": [
                ...
                "curl.exe -s -H \"X-API-Key: dev-local-token\" http://localhost:8000/marketplace/promotion-gate/summarize_document",
                ...
                "curl.exe -s -X POST -H \"X-API-Key: dev-local-token\" http://localhost:8000/marketplace/approval-pack",
                ...
                "curl.exe -s -H \"X-API-Key: dev-local-token\" http://localhost:8000/policy/replay-drift",
                "curl.exe -s -X POST -H \"X-API-Key: dev-local-token\" http://localhost:8000/policy/replay-pack",
                ...
                "curl.exe -s -X POST -H \"X-API-Key: dev-local-token\" http://localhost:8000/prompt-governance/remediation-plan",
    ...
    def _one_command_verification_order(self) -> list[JsonDict]:
        commands = [
            ...
            "Invoke-RestMethod http://localhost:8000/api/contract-drift-pack -Method POST -Headers $headers",
            "Invoke-RestMethod http://localhost:8000/api/contract-remediation-pack -Method POST -Headers $headers",
            'rg "marketplace/catalog|marketplace/promotion-gate|marketplace/rollout-pack|marketplace/approvals|marketplace/approval-pack|Skill Marketplace|Tenant Rollout|marketplace_packs|rollout approval" app dashboard docs README.md tests scripts sample_data',
    ...
    def _demo_service_hint(self, path: str) -> str:
        hints = {
            ...
            "/marketplace/approvals": "state.marketplace.approval_queue",
            "/marketplace/promotion-gate/{skill_id}": "state.marketplace.promotion_gate",
            "/marketplace/approvals/submit": "state.marketplace.submit_approval",
            "/marketplace/approvals/{approval_id}/decision": "state.marketplace.decide_approval",
            "/marketplace/approvals/{approval_id}/stage": "state.marketplace.advance_stage",
            "/marketplace/approval-pack": "state.marketplace.approval_pack",
            ...
            "/providers/failover-drill": "state.provider_failover.drill",
            "/providers/failover-pack": "state.provider_failover.pack",
            "/config/hygiene": "state.config_hygiene.report",
            "/config/hygiene-pack": "state.config_hygiene.pack",
            "/policy/replay-drift": "state.policy_replay.report",
            "/policy/replay-pack": "state.policy_replay.pack",
            "/prompt-governance/report": "state.prompt_governance.report",
            "/prompt-governance/pack": "state.prompt_governance.pack",
            "/prompt-governance/remediation-plan": "state.prompt_governance.remediation_plan",
            ...
            "/platform/operations-drill": "state.platform_operations.drill",
            "/platform/operations-pack": "state.platform_operations.pack",
            ...
            "/workers/replay-report": "state.worker_scaleout.replay_report",
            "/workers/replay-pack": "state.worker_scaleout.replay_pack",
